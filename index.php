...
<body>
    <div class="container d-flex justify-content-center flex-column flex-wrap ml-5 mr-5 mt-5 rounded bg-dark bg-gradient">
        <header>
    ...
    <div class="container d-flex justify-content-center flex-column flex-wrap ml-5 mr-5 mb-5 rounded bg-success bg-gradient">
        ...
        <form action="traitement.php" method="post" class="">
            <p>
                <label>
                <div class="well well-lg display-6 fst-italic user-select-none">Nom du produit : </div>
                    <input type="text" name="name" class="w-50 p-3">
                </label>
            </p>
            <p>
                <label>
                <div class="well well-lg display-6 fst-italic user-select-none">Prix du produit : </div>
                    <input type="number" step="any" name="price" class="w-50 p-3">
                </label>
            </p>
            <p>
                <label>
                <div class="well well-lg display-6 fst-italic user-select-none">Quantité désirée : </div>
